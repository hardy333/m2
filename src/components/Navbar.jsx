  ...
  return (
    <header className="navbar">
      <div className="container navbar__container">
        ...
        <button className="btn btn--outline" data-aos="fade-left">Book a call</button>
      </div>
    </header>
  );
};
